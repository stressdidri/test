...
function Welcome(){
	...
	// welcome background
	img = TextureAtlas.getImage("game/media/bgWelcome.jpg");
	...
	img = TextureAtlas.getImage("game/media/mySpritesheet.png");
...
function HeroArt(){
	...
	var img = TextureAtlas.getImage("game/media/mySpritesheet.png");
...
function BgLayer(layer){
	...
	if (this.layer == 1){
		img = TextureAtlas.getImage("game/media/bgLayer1.jpg");
